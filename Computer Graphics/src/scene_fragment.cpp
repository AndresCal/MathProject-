...
//	glEnableVertexAttribArray(0); //Quiero pedir el atributo 0
...
//	glShaderSource(fragment_shader, 1, &fragment_source_c, nullptr); //el 1 es mando un codigo
//	glCompileShader(fragment_shader);
//
//
//
//	//Creamos el ejecutable, manager
//	shader_program = glCreateProgram();
//
//	glAttachShader(shader_program, vertex_shader);
//	glAttachShader(shader_program, fragment_shader);
//	__glewBindAttribLocation(shader_program, 0, "VertexPosition");//En este shader se une el atributo 0 con vertexPositon
...
void scene_fragment::awake() //Cuando se empieza a dibujar 
{
}
...
void scene_fragment::mainLoop()
{
	...
	glUniform1f(time_location, time::elapsed_time().count()); //Le mando el tiempo 





	glBindVertexArray(vao); //mandamos posiciones
...
void scene_fragment::resize(int width, int height) //Configurar el viewport
{
